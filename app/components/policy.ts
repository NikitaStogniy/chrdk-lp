export const PolicyHTML = `<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8" />
  ...
  <body>
    ...
    <p>
      This privacy policy applies to the Chrdk app (hereby referred to as
      "Application") for mobile devices that was created by Nikita Stogniy
    ...
    <p>
      ...
      please contact them at help@chrdk.com and they will respond in a
      reasonable time.
    </p>
    ...
    <div>
      ...
      <p>
        ...
        (help@chrdk.com) so that they will be able to take the necessary
        actions.
      </p>
    </div>
    ...
    <br />
    <p>This privacy policy is effective as of 2024-08-08</p>
